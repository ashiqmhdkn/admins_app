...
class VideoUpdate extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<VideoUpdate> createState() => _VideoUpdateState();
}

class _VideoUpdateState extends ConsumerState<VideoUpdate> {
  File? videoFile;
  bool _showExistingThumbnail = true;
